package com.shadowmask.core.data

import com.shadowmask.core.model.ModuleJson
import com.shadowmask.core.model.Release
import com.shadowmask.core.model.UpdateJson
...
interface GithubApiServices {
    ...
    suspend fun fetchReleases(
        ...
        @Path("repo") repo: String = "ShadowMask",
