package com.shadowmask;

import static com.shadowmask.BuildConfig.APPLICATION_ID;
...
import com.shadowmask.utils.DynamicClassLoader;
...
public class DynLoad {
    ...
    static DynamicClassLoader loadApk(Context context) {
        ...
        if (BuildConfig.DEBUG) {
            try {
                File external = new File(context.getExternalFilesDir(null), "shadowmask.apk");
                if (external.exists()) {
                    apk.delete();
                    try {
