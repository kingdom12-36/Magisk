...
import com.shadowmask.ui.component.rememberLoadingDialog
import com.shadowmask.ui.flash.FlashUtils
import com.shadowmask.ui.install.InstallBottomSheet
...
private fun EnvFixComposableDialog(
    ...
    val needsFullFix = code == 2 ||
        Info.env.versionCode != com.shadowmask.core.BuildConfig.APP_VERSION_CODE ||
        Info.env.versionString != com.shadowmask.core.BuildConfig.APP_VERSION_NAME
