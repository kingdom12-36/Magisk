...
pub const LOGFILE: &str = "/cache/shadowmask.log";
...
pub const SEPOL_PROC_DOMAIN: &str = "shadowmask";
pub const SHADOWMASK_PROC_CON: &str = concatcp!("u:r:", SEPOL_PROC_DOMAIN, ":s0");
// Unconstrained file type that anyone can access
pub const SEPOL_FILE_TYPE: &str = "shadowmask_file";
pub const SHADOWMASK_FILE_CON: &str = concatcp!("u:object_r:", SEPOL_FILE_TYPE, ":s0");
// Log pipe that only root and zygote can open
pub const SEPOL_LOG_TYPE: &str = "shadowmask_log_file";
pub const SHADOWMASK_LOG_CON: &str = concatcp!("u:object_r:", SEPOL_LOG_TYPE, ":s0");
